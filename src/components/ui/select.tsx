  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="size-4 text-lsd-icon-primary" />
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn('text-lsd-text-secondary px-2 py-1.5 text-xs', className)}
      {...props}
    />
  );
}
    ...
    >
      <span className="absolute right-2 flex size-3.5 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-4 text-lsd-icon-primary" />
        </SelectPrimitive.ItemIndicator>
      </span>
